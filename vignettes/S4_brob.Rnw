...
\Address{
  ...
  E-mail: \email{hankin.robin@gmail.com}\hfill\includegraphics[width=1in]{\Sexpr{system.file("help/figures/brobdingnag.png",package="Brobdingnag")}}
}
...
\hfill\includegraphics[width=1in]{\Sexpr{system.file("help/figures/brobdingnag.png",package="Brobdingnag")}}
