...
out.num <- cubature::hcubature(f = f.numeric, lowerLimit = -2, upperLimit = 2, vectorInterface = TRUE)
out.num
```
...
out.brob <- cubature::hcubature(f = f.brob, lowerLimit = -2, upperLimit = 2, vectorInterface = TRUE)
out.brob
```
